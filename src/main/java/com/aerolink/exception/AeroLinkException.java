 ...
 *
 * <p>Carries an {@link ErrorCode} so the global handler knows exactly which HTTP status and error
 * code to return — no need to inspect exception types or messages in the handler.
 *
 * <p>Optionally carries {@code retryAfterSeconds} for rate-limit (429) responses.
 */
@Getter
