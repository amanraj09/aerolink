...
/**
 * Holds the industry-standard identifiers used to reference an airport across different aviation
 ...
 */
public record AirportIdentifier(String icaoId, String iataId, String faaId) {}
